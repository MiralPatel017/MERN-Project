...
const AdminPanelPage = () => {
    ...
    const handleDeleteUser = async (_id) => {
        try {
            await axios.delete(`https://ecom-backend-production-66e4.up.railway.app/user/delete-user/${_id}`)
    ...
    const handleDeleteProduct = async (_id) => {
        ...
        try {
            await axios.delete(` https://ecom-backend-production-66e4.up.railway.app/product/delete-product/${_id}`)
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('https://ecom-backend-production-66e4.up.railway.app/product/add-new-product', newFormData, {
                headers: {
    ...
    const handleEditFormSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(
                `https://ecom-backend-production-66e4.up.railway.app/product/update-product/${editForm._id}`,
                updatedFormData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
