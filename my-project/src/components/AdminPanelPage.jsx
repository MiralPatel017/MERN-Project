...
const AdminPanelPage = () => {
    ...
    const handleDeleteUser = async (_id) => {
        try {
            await axios.delete(`http://localhost:5713/user/delete-user/${_id}`)
    ...
    const handleDeleteProduct = async (_id) => {
        ...
        try {
            await axios.delete(` http://localhost:5713/product/delete-product/${_id}`)
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:5713/product/add-new-product', newFormData, {
                headers: {
    ...
    const handleEditFormSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(
                `http://localhost:5713/product/update-product/${editForm._id}`,
                updatedFormData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
